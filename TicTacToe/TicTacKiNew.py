...
class Board:
    ...
    def print_board(self):
        print(" " + self.convert(self.state[0]) + " | " + self.convert(self.state[1]) + " | " + self.convert(
            self.state[2]) + " ")
        print(" " + self.convert(self.state[3]) + " | " + self.convert(self.state[4]) + " | " + self.convert(
            self.state[5]) + " ")
        print(" " + self.convert(self.state[6]) + " | " + self.convert(self.state[7]) + " | " + self.convert(
            self.state[8]) + " ")
...
if __name__ == '__main__':
    ...
    while not board.is_full():
        if active_player.ki:
            turn = board.ki_main()
            board.make_turn(turn, active_player)
            print("Computer: ")
            board.print_board()
